/*global history */
sap.ui.define([
	"innovator/books/Books/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"sap/m/GroupHeaderListItem",
	"sap/ui/Device",
	"innovator/books/Books/model/formatter",
	"sap/m/MessageBox",
	"innovator/books/Books/model/grouper",
	...
	return BaseController.extend("innovator.books.Books.controller.Master", {
		...
		onSearch: function (oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter("BookTitle", FilterOperator.Contains, sQuery)];
			} else {
		...
		onOpenViewSettings: function () {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("innovator.books.Books.view.ViewSettingsDialog", this);
		...
		onConfirmViewSettingsDialog: function (oEvent) {
			...
			aFilterItems.forEach(function (oItem) {
				switch (oItem.getKey()) {
				case "Filter1":
					aFilters.push(new Filter("ISBN", FilterOperator.LE, 100));
					break;
				case "Filter2":
					aFilters.push(new Filter("ISBN", FilterOperator.GT, 100));
					break;
				default:
					break;
				}
