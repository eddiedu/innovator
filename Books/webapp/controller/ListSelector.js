sap.ui.define([
	...
	return BaseObject.extend("innovator.books.Books.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias innovator.books.Books.model.ListSelector
		 */
		 ...
		 * @return {innovator.books.Books.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
